...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "RelayMedia" },
      { name: "description", content: "RelayMedia connects to your Emby Plex or Jellyfin server to stream your media library." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "RelayMedia" },
      { property: "og:description", content: "RelayMedia connects to your Emby Plex or Jellyfin server to stream your media library." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "RelayMedia" },
      { name: "twitter:description", content: "RelayMedia connects to your Emby Plex or Jellyfin server to stream your media library." },
