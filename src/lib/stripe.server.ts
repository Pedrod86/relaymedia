...
// Routes api.stripe.com requests through the connector gateway, which holds the
// real Stripe secret key. The env vars here are gateway connection identifiers,
// NOT Stripe secret keys — never pass them to Stripe directly.
...
// Verifies the Stripe webhook signature with HMAC-SHA256 (no SDK / gateway needed).
